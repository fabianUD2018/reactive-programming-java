package com.fabian.co.webfluxcourse.models.controllers;
...
public class ProductoController {
	...
	public String listarDataDriver(Model model) {
		...
		Flux<Producto> productos = service.findAll().delayElements(Duration.ofSeconds(1));
	...
	public String listarFull(Model model) {
		...
		Flux<Producto> productos = service.findAll().repeat(500);
