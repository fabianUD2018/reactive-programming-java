...
public class SpringBootWebFluxFunctionalEndpointApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringBootWebFluxFunctionalEndpointApplication.class, args);
	}
